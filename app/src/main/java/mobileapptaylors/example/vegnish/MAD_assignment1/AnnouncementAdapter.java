...
public class AnnouncementAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            viewHolder.txtType = (TextView) convertView.findViewById(mobileapptaylors.example.vegnish.MAD_assignment1.R.id.txtType);
            viewHolder.txtDescription = (TextView) convertView.findViewById(mobileapptaylors.example.vegnish.MAD_assignment1.R.id.txtDescription);
            viewHolder.ivPlay = (ImageView) convertView.findViewById(mobileapptaylors.example.vegnish.MAD_assignment1.R.id.ivPlay);
            viewHolder.ivStop = (ImageView) convertView.findViewById(mobileapptaylors.example.vegnish.MAD_assignment1.R.id.ivStop);
            ...
            public void onClick(View v){
                if(!(hashID == 0)){
                    if(hashID == viewHolder.hashCode()) {
                        ...
                        temp.ivPlay.setImageResource(mobileapptaylors.example.vegnish.MAD_assignment1.R.drawable.ic_play);
                    }
                }
...
//                System.out.println("ViewHolder ID"+viewHolder.hashCode());
                ...
                if(mediaPlayer.isPlaying()){
                    mediaPlayer.pause();
                    viewHolder.ivPlay.setImageResource(mobileapptaylors.example.vegnish.MAD_assignment1.R.drawable.ic_play);
                }
                else{
                    mediaPlayer.start();
                    viewHolder.ivPlay.setImageResource(mobileapptaylors.example.vegnish.MAD_assignment1.R.drawable.ic_pause);
...
//                            Toast.makeText(context,"END OF AUDIO", Toast.LENGTH_SHORT).show();
                                ...
                                ViewGroup container = (ViewGroup) layoutInflater2.inflate(mobileapptaylors.example.vegnish.MAD_assignment1.R.layout.popup_message, null);
                                ...
                                container.setOnTouchListener(new View.OnTouchListener() {
                                    ...
                                    public boolean onTouch(View v, MotionEvent event) {
                                        ...
                                        if(viewHolder.txtDescription.getText().toString().equals("For MCQ examination")){
                                            mediaPlayer2 = MediaPlayer.create(context, mobileapptaylors.example.vegnish.MAD_assignment1.R.raw.with_mcq);
                                            mediaPlayer2.start();
